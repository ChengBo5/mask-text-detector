    ...
    do
        ...
        do
            ...
            do
                ...
                zip -jmq dataset/result/zip/icdar2015_rpn_box.zip dataset/result/icdar2015_rpn_box/* ;
                python evaluate/ICDAR2015/script.py -g=evaluate/ICDAR2015/gt.zip -s=dataset/result/zip/icdar2015_rpn_box.zip >&1 | tee -a $log_dir ;
