...
input_dir = 'dataset/result/TotalText_mask_box' #detection directory goes here
gt_dir = 'evaluate/TotalText/Test_mat' #gt directory goes here
fid_path = 'dataset/result/txt/TotalText.txt' #output text file directory goes here
